...
allow_re='(<your-handle>|<random>|<user>|<name>|<unit>|example\.(com|org|net)|@[A-Za-z0-9.-]+\.(invalid|test|example|localhost)|orchestrator@local|noreply@|127\.0\.0\.1|0\.0\.0\.0|/home/\$|/Users/\$|\$HOME|\$USER|x{8})'
