...
(`~/projects/claude-orchestrator`) at the same time:

| Run | TEAM_RUN_ID | TEAM_DIR | tmux | goal | working tree |
|---|---|---|---|---|---|
| A (this one) | `r177974008611364` | `.team-r177974008611364` | `orch-60650` | arrival-feedback | `~/projects/app-a` |
| B | `r177974012512194` | `.team-b9-e2e` | `orch-98934` | chart-no-data | `~/projects/app-b` |
